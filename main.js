...
async function main() {
  ...
  try {
    ...
    if (!canvas) {
      console.error(
        "Canvas element not found. Make sure the canvas element with ID 'my-canvas' exists in your HTML."
      )
      return
    }
    ...
    const lens = await cameraKit.lensRepository.loadLens(
      "6dc7e58c-9419-474a-8814-cd86d74ef5a7",
      "b8c6bfe8-e0da-4beb-b687-d18041f69dae"
    )
